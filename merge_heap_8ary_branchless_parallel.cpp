		...
		public:
			...
			void promote() {
				...
				while (true) {
					...
					best_i = cache[child + 4] > best ? child + 4 : best_i;
					best = cache[child + 4] > best ? cache[child + 4] : best;

					best_i = cache[child + 5] > best ? child + 5 : best_i;
					best = cache[child + 5] > best ? cache[child + 5] : best;

					best_i = cache[child + 6] > best ? child + 6 : best_i;
					best = cache[child + 6] > best ? cache[child + 6] : best;

					best_i = cache[child + 7] > best ? child + 7 : best_i;
					best = cache[child + 7] > best ? cache[child + 7] : best;
...
bool MergeHeap8aryBranchlessParallel::merge(struct test *t, int n) {
