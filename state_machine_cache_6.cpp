...
if (cache[5] >= cache[0])
	goto ORDER_543216;
else if (cache[5] >= cache[1])
	goto ORDER_643215;
else if (cache[5] >= cache[2])
	goto ORDER_653214;
else if (cache[5] >= cache[3])
	goto ORDER_654213;
else if (cache[5] >= cache[4])
	goto ORDER_654312;
else
	goto ORDER_654321;
