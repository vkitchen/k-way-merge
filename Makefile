...
all: gen merge-heap merge-qsort merge-insertion-sort merge-state-machine
...
clean:
	rm gen merge-heap merge-qsort merge-insertion-sort merge-state-machine gen.o merge-heap.o merge-qsort.o merge-insertion-sort.o merge-state-machine.o harness.o state-machine.c
