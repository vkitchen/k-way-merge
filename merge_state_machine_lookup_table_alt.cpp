...
void merge_state_machine_lookup_table_alt_3(struct test *t) {
	int *segments[3];
...
void merge_state_machine_lookup_table_alt_4(struct test *t) {
	int *segments[4];
...
void merge_state_machine_lookup_table_alt_6(struct test *t) {
	int *segments[6];
...
void merge_state_machine_lookup_table_alt_8(struct test *t) {
	int *segments[8];
...
bool MergeStateMachineLookupTableAlt::merge(struct test *t, int n) {
	if (n == 3)
